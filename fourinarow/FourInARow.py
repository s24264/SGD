...
def drawBoard(board, extraToken=None, turn=None):
    ...
    if extraToken and extraToken.get('color') == RED:
        drawTurnIndicator(HUMAN)
    elif extraToken and extraToken.get('color') == BLACK:
        drawTurnIndicator(COMPUTER)
...
def drawTurnIndicator(turn):
    ...
    if turn == HUMAN:
        text = font.render("Tura: Gracz", True, TEXTCOLOR)
    else:
        text = font.render("Tura: Komputer", True, TEXTCOLOR)
