...
def displayLevelComplete():

    levelCompleteText = "Level Complete!"
    levelCompleteFont = pygame.font.SysFont('Arial', 50)
    levelCompleteSurface = levelCompleteFont.render(levelCompleteText, True, (255, 255, 255))
    levelCompleteRect = levelCompleteSurface.get_rect()
    levelCompleteRect.center = (HALF_WINWIDTH, HALF_WINHEIGHT)

    DISPLAYSURF.blit(levelCompleteSurface, levelCompleteRect)
    pygame.display.update()
